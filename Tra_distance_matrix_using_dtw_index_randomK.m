function [distance_Mat,index_Mat] = Tra_distance_matrix_using_dtw_index_randomK(latLong_using_prototypes_index, SP, randnum, num)
...
for indxxx = 1:num
    ...
    for j = 1: numberOfTrajectories
        ...
        distance(j) = Tra_index_dtw(a,b,SPdistMat);
        distance(j) = min(Tra_index_dtw(a,b(end:-1:1),SPdistMat), distance(j));
